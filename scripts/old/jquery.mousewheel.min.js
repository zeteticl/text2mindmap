...
(function (c) {
    ...
    var m = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"],
        ...
        k, j;
    if (c.event.fixHooks)
        for (var n = m.length; n;) c.event.fixHooks[m[--n]] = c.event.mouseHooks;
    c.event.special.mousewheel = {
        setup: function () {
            if (this.addEventListener)
                for (var b =
                        g.length; b;) this.addEventListener(g[--b], l, !1);
            else this.onmousewheel = l
        },
        teardown: function () {
            if (this.removeEventListener)
                for (var b = g.length; b;) this.removeEventListener(g[--b], l, !1);
