mindmap = (function () {
    ...
    $(document).ready(function () {
        ...
        setCookie = function () {
            if ("error404" != viewcode) {
                ...
                a = new Date;
                a.setTime(a.getTime() + 86400000 * 365);
                $.cookie("timestamp", "1", {
                    expires: a
                })
            }
    ...
    var I = function (q, r) {
        ...
        var e = {
            bgcolors: "#2365ba #16c75e #9999CC #CC6666 #ff481c #31975A #C2583F #003366 #FF9966 #99CC99 #C2903F #E86850 #587058 #919581 #CC0000 #666666 #365C8E".split(" "),
            coloringMode: 2,
            fontSize: 20,
            fontMinSize: 11,
